...
//     print('homelist: ${homeList.length}');
//     homeList.forEach(
//       (e) {
//         print(e.name);
//         print(e.homeId);
...
//           // } 80531378
//           print('nexthome:');
//           var nextHome = homeList[e.key];
//           print('${nextHome.name} : ${nextHome.homeId}');
//           return PopupMenuItem<String>(
//               height: 0,
//               onTap: () {
//                 print('delete home: ${nextHome.name}: ${nextHome.homeId}');
//                 final tuyaHandler = TuyaHandler();
//                 tuyaHandler.removeHome(nextHome.homeId, () {
//                   print('success');
//                 }, (message) {
//                   print(message);
//                 });

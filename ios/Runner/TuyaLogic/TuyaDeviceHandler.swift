...
class TuyaDeviceHandler : NSObject{
    ...
    public func getDeviceTimers(result:@escaping FlutterResult, deviceId: String) {
        
        self.tuyaSmartTimer.getTaskList(withBizId: deviceId,  bizType: 0, success: { (list) in
...
//            print(timersData.toJSONString())
            result(timersData.toJSONString())

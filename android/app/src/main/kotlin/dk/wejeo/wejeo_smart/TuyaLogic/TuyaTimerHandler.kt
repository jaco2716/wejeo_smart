...
////    }
//
//    fun  getDeviceTimers(completion: @escaping (String) -> Void, failure: @escaping (Error?) -> Void) {
//
...
//
//
//    fun  addDeviceTimer(result: MethodChannel.Result, deviceId: String, time: String, loops: String, dpsStatus: Boolean) {
//        val dps = {"1" to dpsStatus}
//
//
//
...
//
//
//    fun  updateTimerStatus(result: MethodChannel.Result, deviceId: String, timerIds: [String], updateType: Int32) {
//
